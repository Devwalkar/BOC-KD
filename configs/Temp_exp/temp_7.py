...
train_cfg = dict(
    ...
    criterion=dict(
        ...
        contribution_ratios = [0.7,0.15,0.15] # Contribution ratios for all losses 
    ...
    scheduler=dict(
       ...
       #patience=1,                   # For ReduceLROnPlateau
        ...
        #exp_gamma=0.1,
        #verbose=True
        milestones=[300],   # For MultiStepLR
        last_epoch=-1,
        gamma=0.1
    ),
    ...
    KL_loss_temperature = 7,            # Temperature for creating softened log softmax for KL loss 
    test_interval = 10,
